    ...
    <?php foreach ($pendahuluan as $pl) : ?>
        <div class="ml-5 mr-5">
            ...
            <h1 class="text-center mt-5">
                <font face="times">
                    <center> PROPOSAL <br> <?= $pl['tema_kegiatan'] ?><br> <?= $nama['nama'] ?> <?= date('Y') ?>
                    </center>
                </font>
            </h1>
            <br>
            ...
            <tr>
                ...
                <td>
                    <font size="12 px" face="times">
                        <h4>Atas nama keluarga besar <?= $nama['nama'] ?>, kami selaku panitia berterimaksih kepada teman teman dan pihak yang telah memberikan dukungan moril maupun materil untuk kesuksesan kegiatan IT Explore ini.</h4>
                    </font>
                </td>
            </tr>
            </table>
